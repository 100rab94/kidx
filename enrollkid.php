...
<div id='kidfrm'>
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" class="wrapper" autocomplete="off" enctype="multipart/form-data">
		<h1 align="center">Kid Enrollment</h1>
				  <div class="form-group">
				    
				    First Name:<input type="text" class="form-control" name="firstname" placeholder="First Name" required>
				  </div>
				   <div class="form-group">
				    
				    Last Name:<input type="text" class="form-control" name="lastname" placeholder="Last Name" required>
				  </div>
				   <div class="form-group">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
				    ...
				    Parent Email*:<input type="text" class="form-control" name="pemail" placeholder="Enter Parent Email" required>
				  </div>
				  <div class="form-group">	
				<label>Class: </label>
